...
`"rapp/1:egg-manifest"`, `"rapp/1:rappid"`, `"rapp/1:grail"`, `"rapp/1:seal"`. A tag is used by either `H`
or `Hb`, never both. Output is always exactly 64 lowercase hex, **never truncated or uppercased**. Two values
