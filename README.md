...
| **[`book/`](book/README.md)** | *The RAPP Programming Language* — the expanded tutorial and reference manual; [read the paper-styled edition](https://kody-w.github.io/rapp-1/book/) |
...
A complete tutorial and reference in three parts, with a dedicated paper-styled GitHub Pages
edition. **[Open the book →](https://kody-w.github.io/rapp-1/book/)**
