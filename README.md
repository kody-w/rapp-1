...
| **[`book/`](book/README.md)** | *The RAPP Programming Language* — the expanded tutorial, workbook, and reference manual; [read the paper-styled edition](https://kody-w.github.io/rapp-1/book/) |
