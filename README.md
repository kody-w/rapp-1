...
| **[`trust/`](trust/README.md)** | unsigned trust-registry proposal, Ed25519 signing/verifying tooling, synthetic vectors, and owner/license handoffs |
...
RAPP rev-6. The reference profile passes 16/16 controlled checks on every push — CI runs the
