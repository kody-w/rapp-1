...
`rev-15` are lookup labels. `SPEC.md` is generated byte-for-byte from the
...
python3 anchor/materialize_spec.py --revision rev-15 --output SPEC.md
python3 anchor/materialize_spec.py --seq 15 --output SPEC.md
