...
| your own signature on each of those two (a kernel, a release) | a declared entry: signed by the owner in effect at its `activated_utc`, retained unchanged once accepted; a copy elsewhere counts only when its canonical form equals a carried entry's | §13.4 |
